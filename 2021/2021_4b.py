...
while len(data1) > 1:
    winlist = getwinlist(data1)
    del data1[winlist[1]]

finalwinlist = getwinlist(data1)


callednums = winningnums[:finalwinlist[0]+1]

winningscratch = data1[finalwinlist[1]][:5]
...
lastcall = int(winningnums[finalwinlist[0]])
